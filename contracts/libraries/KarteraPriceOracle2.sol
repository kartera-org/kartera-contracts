...
contract KarteraPriceOracle2 is KarteraPriceOracle{
    ...
    function addToken(address tokenaddress, uint8 len, address[] calldata claddress) external virtual override {
